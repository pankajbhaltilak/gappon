  ...
  return (
    <div className="pb-20">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="container-pad relative flex min-h-[80vh] items-center py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-relaxed text-white/75">Business-ready shirts and trousers for retailers and distributors with consistent quality and delivery.</p>
            <div className="mt-10 flex gap-4">
              ...
              <Link href="/contact" className="rounded-full border border-white/30 px-8 py-3 text-xs uppercase tracking-[0.2em] text-white">
                Contact Us
              </Link>
            </div>
          </div>
      ...
      <AnimatedSection className="container-pad pb-10">
